...
import { Phone, Mail, ArrowRight, GraduationCap, Users, Trophy, Briefcase, Bell, Award, Download, FileText, Library, ShieldCheck, Cpu, Building2, ChevronRight, Droplets, Camera, Wifi, MapPin, BookOpen } from "lucide-react";
...
function Index() {
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsx("header", { className: "sticky top-0 z-40 bg-background/85 backdrop-blur border-b border-border", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl px-4 h-16 flex items-center justify-between", children: [
      ...
      /* @__PURE__ */ jsx("nav", { className: "hidden lg:flex items-center gap-7 text-sm", children: nav.map((n, i) => /* @__PURE__ */ jsx("a", { href: n.href, className: `relative text-foreground/80 hover:text-foreground transition-colors ${i === 0 ? "text-foreground after:absolute after:-bottom-1 after:left-0 after:h-0.5 after:w-6 after:bg-gold" : ""}`, children: n.label }, n.label)) }),
      /* @__PURE__ */ jsx("a", { href: "#contact", className: "hidden sm:inline-flex items-center gap-2 rounded-lg bg-navy text-navy-foreground px-4 py-2 text-sm font-medium hover:opacity-90 transition", children: "Contact Us" })
    ] }) }),
