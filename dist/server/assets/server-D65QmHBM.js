...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-TQ3bmjIn.js");
...
const manifest = {
  "e53645915faeefe9ec8a5c659425f2bbf5f82db1bdf3dce4274b132f7cb4a596": {
    functionName: "getAuthenticationParametersFn_createServerFn_handler",
    importer: () => import("./imageKitAuth-CTWMKDtB.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Bxzv1aIu.js").then((n) => n.r),
    import("./start-DKl1h1LF.js"),
